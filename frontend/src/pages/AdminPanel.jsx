...
const AdminPanel = () => {
  ...
  return (
    <div className='p-4 md:p-8 space-y-8 md:space-y-12 bg-gray-50 min-h-screen'>
      ...
      <section className='bg-white p-4 md:p-8 rounded-lg shadow-lg'>
        ...
        <form onSubmit={handleProjectSubmit} className='grid gap-4 md:gap-5'>
          <input type='text' placeholder='Project Name' className='p-2 md:p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400' onChange={e => setProject({ ...project, name: e.target.value })} required />
          <textarea placeholder='Project Description' className='p-2 md:p-3 border border-gray-300 rounded-md resize-none focus:outline-none focus:ring-2 focus:ring-blue-400' onChange={e => setProject({ ...project, description: e.target.value })} required></textarea>
          <input type='file' className='p-1 md:p-2' onChange={e => setProject({ ...project, image: e.target.files[0] })} required />
      ...
      <section className='bg-white p-4 md:p-8 rounded-lg shadow-lg'>
        ...
        <form onSubmit={handleClientSubmit} className='grid gap-4 md:gap-5'>
          <input type='text' placeholder='Client Name' className='p-2 md:p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400' onChange={e => setClient({ ...client, name: e.target.value })} required />
          <input type='text' placeholder='Client Designation' className='p-2 md:p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400' onChange={e => setClient({ ...client, designation: e.target.value })} required />
          <textarea placeholder='Client Description' className='p-2 md:p-3 border border-gray-300 rounded-md resize-none focus:outline-none focus:ring-2 focus:ring-blue-400' onChange={e => setClient({ ...client, description: e.target.value })} required></textarea>
          <input type='file' className='p-1 md:p-2' onChange={e => setClient({ ...client, image: e.target.files[0] })} required />
